...
public class InventoryManager : MonoBehaviour
{
    ...
    {
        Items.Remove(item);
         // Find the InventoryItemController associated with the item
        InventoryItemController itemControllerToRemove = null;
        foreach (var itemController in InventoryItems)
        {
        if (itemController.Item == item)
        {
    ...
    if (itemControllerToRemove != null)
    {
        ...
        List<InventoryItemController> updatedInventoryItems = new List<InventoryItemController>(InventoryItems);
        updatedInventoryItems.Remove(itemControllerToRemove);
        InventoryItems = updatedInventoryItems.ToArray();

        // Destroy the associated game object
        Destroy(itemControllerToRemove.gameObject);
    }
    }
