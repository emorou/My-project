...
public class Tutorial : MonoBehaviour
{
    ...
    {
        if(!isChamber1TutorialDone && !DialogueManager.instance.dialogueIsPlaying && slide4Done)
        {
    ...
    void Chamber2Tutorial()
    {
        ...
        if(slide5Done && !DialogueManager.instance.dialogueIsPlaying && !isChamber2TutorialDone)
        {
